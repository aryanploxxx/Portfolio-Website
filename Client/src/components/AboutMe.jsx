...
const AboutMe = () => {
  return (
    <div className="h-screen flex flex-col flex-wrap justify-center items-left gap-5 w-[70%] text-white">
      ...
      <p className="about-me-description w-full font-['Gilroy'] font-bold">
        i craft&nbsp;
            <span className="highlight text-[#c1ef7b]">
                beautiful digital experiences,&nbsp;
            </span>
        one pixel at a time with a passion for perfection & a dash of creativity!
      </p>  
